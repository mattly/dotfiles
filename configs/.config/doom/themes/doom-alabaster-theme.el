...
(def-doom-theme doom-alabaster
  ...
  ((bg         '("#f7f7f7" nil       nil))
   ...
   (base4      '("#777777" "#9ca0a4" "brightblack"))
   ...
   (grey       base4)
   (red        '("#AA3731" "#e45649" "red"))
   (orange     '("#cb9000" "#dd8844" "brightred"))
   (green      '("#448C27" "#50a14f" "green"))
   (teal       '("#4db5bd" "#44b9b1" "brightgreen"))
   (yellow     '("#FFBC5D" "#986801" "yellow"))
   (blue       '("#325CC0" "#4078f2" "brightblue"))
   (dark-blue  '("#a0bcf8" "#a0bcf8" "blue"))
   (magenta    '("#E64CE6" "#a626a4" "magenta"))
   (violet     '("#7A3E9D" "#b751b6" "brightmagenta"))
   (cyan       '("#0083B2" "#0184bc" "brightcyan"))
